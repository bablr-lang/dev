...
gitClient.clone('git@github.com:bablr-lang/agast-vm-strategy-passthrough.git');
...
gitClient.clone('git@github.com:bablr-lang/dev.git');
gitClient.clone('git@github.com:bablr-lang/eslint-config-base.git');
gitClient.clone('git@github.com:bablr-lang/language-agast-vm-instruction.git');
...
gitClient.clone('git@github.com:bablr-lang/language-js.git');
...
gitClient.clone('git@github.com:bablr-lang/test-runner.git');
